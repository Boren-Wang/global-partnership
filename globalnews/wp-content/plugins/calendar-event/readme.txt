...
*  [Calendar Event FAQ](http://total-soft.pe.hu/calendar-event-faq/)
*  [Calendar Event User Manual](http://total-soft.pe.hu/calendar-event-user-manual/)
...
*  8 free calendar themes with the option of select data ranges, mark events and others (4 versions of the calendar event type, 2 versions of the simple calendar type and 2 versions of the flexible calendar type)
...
1. An example of plugin in action (Calendar Event Theme)
2. An example of plugin in action (Calendar Event Theme)
3. An example of plugin in action (Calendar Event Theme)
4. An example of plugin in action (Calendar Event Theme)
5. An example of plugin in action (Calendar Event Theme)
10. An example of plugin in action (Calendar Event Theme)
11. An example of plugin in action (Calendar Event Theme)
12. An example of plugin in action (Calendar Event Theme)
13. An example of plugin in action (Simple Calendar Theme)
14. An example of plugin in action (Simple Calendar Theme)
15. An example of plugin in action (Simple Calendar Theme)
16. An example of plugin in action (Flexible Calendar Theme)
17. An example of plugin in action (Flexible Event Theme)
18. An example of plugin in action (Flexible Calendar Theme)
19. An example of plugin in action (Flexible Calendar Theme)

== Changelog ==

= Version 1.1.5 (19.01.2016) =
